<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo + Role-Based Redirect + Label -->
                <div class="shrink-0 flex items-center">
                    @php
                        ...
                        $dashboardLabel = match($role) {
                            ...
                            'guru_penyeleksi' => 'Dashboard Penyeleksi',
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="$dashboardUrl" :active="request()->is(ltrim(parse_url($dashboardUrl, PHP_URL_PATH), '/'))">
                        {{ $dashboardLabel }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="$dashboardUrl" :active="request()->is(ltrim(parse_url($dashboardUrl, PHP_URL_PATH), '/') )">
                {{ $dashboardLabel }}
