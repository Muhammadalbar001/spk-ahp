...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // ✅ Reset routes
    Route::delete('reset/pairwise', [ResetController::class, 'resetPairwise'])->name('reset.pairwise');
    Route::delete('reset/nilai', [ResetController::class, 'resetNilai'])->name('reset.nilai');
    Route::delete('reset/hasil', [ResetController::class, 'resetHasil'])->name('reset.hasil');
});
...
// ✅ Penilai (Wali Kelas, Waka, Penyeleksi)
Route::middleware(['auth'])->group(function () {
    // Wali
