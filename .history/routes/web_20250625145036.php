...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::delete('/reset/pairwise', [ResetController::class, 'pairwise'])->name('reset.pairwise');
    Route::delete('/reset/nilai', [ResetController::class, 'nilai'])->name('reset.nilai');
    Route::delete('/reset/hasil', [ResetController::class, 'hasil'])->name('reset.hasil');
